...
from PyQt5.QtWidgets import QDialog, QListWidgetItem, QListWidget, QMenu
from PyQt5.QtBluetooth import (QBluetoothAddress, QBluetoothDeviceDiscoveryAgent,
...
class DeviceDiscoveryDialog(QDialog):
    ...
    @pyqtSlot(QBluetoothAddress, "QBluetoothLocalDevice::Pairing")
